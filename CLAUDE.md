...
./gradlew :app:testDebugUnitTest --tests "pl.mtajchert.clipboardhero.ImageTransformerTest"
...
- Success signals: system clipboard overlay appears; Gboard shows the image chip;
  `adb exec-out run-as pl.mtajchert.clipboardhero ls files/clips/` shows the clip.
